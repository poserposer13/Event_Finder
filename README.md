...
~THEN I am presented with a list of event with artist(s) that I've submitted along with similar artists
to the one I entered.
...
~WHEN I search for a band/artist
~THEN I am presented with a responsive map showing where the listed events are.(Even more frosting here)
And I see a picture of the artist that I've searched for.
